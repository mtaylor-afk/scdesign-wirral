    ...
    <Section className="pt-16">
      <Container className="max-w-3xl">
        ...
        <div className="mt-4 rounded-[var(--radius)] border border-accent-soft bg-accent-soft/40 p-4 text-sm text-ink-soft">
          This policy explains how {site.name} handles website enquiries, cookies and visualiser
          use. It is reviewed periodically as the website and services evolve, and is provided for
