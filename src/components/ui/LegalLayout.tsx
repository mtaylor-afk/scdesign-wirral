    ...
    <Section className="pt-16">
      <Container className="max-w-3xl">
        ...
        <div className="mt-4 rounded-[var(--radius)] border border-accent-soft bg-accent-soft/40 p-4 text-sm text-ink-soft">
          <strong>Draft for legal review.</strong> This document is a sensible starting point for a
          small UK service business and must be reviewed by a suitably qualified person before
